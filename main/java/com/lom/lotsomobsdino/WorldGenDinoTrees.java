...
public class WorldGenDinoTrees extends WorldGenAbstractTree
{
    ...
    public WorldGenDinoTrees(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenDinoTrees(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
        this.minTreeHeight = par2*2;
        this.metaWood = par3;
        this.metaLeaves = 3;
        this.vinesGrow = par5;
    }
            ...
            else
            {
                ...
                if (isSoil && par4 < 256 - l - 1)
                {
                    ...
                    for (k1 = 0; k1 < l; ++k1)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k1, par5, LotsOMobsBlocks.DinoLog, this.metaWood);
