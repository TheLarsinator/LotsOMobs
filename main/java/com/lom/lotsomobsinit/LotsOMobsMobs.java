...
//Temporary fix for missing vanilla creature spawn:
        ...
        EntityRegistry.addSpawn(EntityHorse.class, 20, 1, 4, EnumCreatureType.creature, new BiomeGenBase[] {BiomeGenBase.plains});
				...
				{ 
			        ...
			        EntityRegistry.addSpawn(EntityWhale.class, (int)(ConfigHandler.WhaleRate *10), 1, 4, EnumCreatureType.waterCreature, new BiomeGenBase[] {BiomeGenBase.ocean, BiomeGenBase.frozenOcean});
			        EntityRegistry.addSpawn(EntityWhale.class, (int)(ConfigHandler.WhaleRate *10), 1, 4, EnumCreatureType.waterCreature, BiomeDictionary.getBiomesForType(Type.OCEAN));
				...
				if(ConfigHandler.NarwalOn == true)
				{
			    	...
			    	{ 
			        EntityRegistry.addSpawn(EntityNarwal.class, (int)(ConfigHandler.NarwhaleRate *10), 1, 2, EnumCreatureType.waterCreature, new BiomeGenBase[] {BiomeGenBase.ocean, BiomeGenBase.frozenOcean, LotsOMobsBiomes.modBiomeArcticOcean});
			    	}
			        EntityRegistry.addSpawn(EntityNarwal.class, (int)(ConfigHandler.NarwhaleRate *10), 1, 4, EnumCreatureType.waterCreature, BiomeDictionary.getBiomesForType(Type.OCEAN));
				...
				{    
			    	...
			    	if(ConfigHandler.newBiomes)
			    	{ 
			        EntityRegistry.addSpawn(EntityTropicalFishy.class, (int)ConfigHandler.FishyRate *10), 8, 20, EnumCreatureType.waterCreature, new BiomeGenBase[] {LotsOMobsBiomes.modBiomeTropical});
			    	}
			    }*/
				...
				{  
			    	registerModEntityWithEgg(EntityGazelle.class, mobid + "Gazelle", 0xc8953b, 0xf9f9f9);
			     	EntityRegistry.addSpawn(EntityGazelle.class, (int)(ConfigHandler.GazelleRate*10), 6, 9, EnumCreatureType.creature, new BiomeGenBase[] {BiomeGenBase.savanna, BiomeGenBase.savannaPlateau});
				...
				if(ConfigHandler.SharkOn == true)
				{
					...
					if(ConfigHandler.newBiomes)
			        EntityRegistry.addSpawn(EntityHammerShark.class, (int)(ConfigHandler.SharkRate *10), 3, 5, EnumCreatureType.waterCreature, new BiomeGenBase[] {LotsOMobsBiomes.modBiomeTropical});
			        EntityRegistry.addSpawn(EntityHammerShark.class, (int)(ConfigHandler.SharkRate *5), 1, 4, EnumCreatureType.waterCreature, BiomeDictionary.getBiomesForType(Type.OCEAN));
					registerModEntityWithEgg(EntityShark.class, mobid + "Shark", 0x959595, 0x7d7d7d);

			        EntityRegistry.addSpawn(EntityShark.class, (int)(ConfigHandler.SharkRate *5), 1, 4, EnumCreatureType.waterCreature, BiomeDictionary.getBiomesForType(Type.OCEAN));

			        EntityRegistry.addSpawn(EntityShark.class, (int)(ConfigHandler.SharkRate *5), 3, 5, EnumCreatureType.waterCreature, new BiomeGenBase[] {BiomeGenBase.ocean});
				}
				if(ConfigHandler.CrabOn == true)
				{
					...
					EntityRegistry.addSpawn(EntityCrab.class, (int)(ConfigHandler.CrabRate *10), 1, 4, EnumCreatureType.creature, BiomeDictionary.getBiomesForType(Type.BEACH));
				...
				{    
					...
					EntityRegistry.addSpawn(EntityBigFishy.class, (int)(ConfigHandler.FishyRate*10), 8, 14, EnumCreatureType.waterCreature, new BiomeGenBase[] {BiomeGenBase.ocean, BiomeGenBase.deepOcean, BiomeGenBase.river});
			        EntityRegistry.addSpawn(EntityBigFishy.class, 50, 1, 4, EnumCreatureType.waterCreature, BiomeDictionary.getBiomesForType(Type.OCEAN));

				}
				if(ConfigHandler.FishyOn == true)
				{    
			        registerModEntityWithEgg(EntitySeaHorse.class, mobid + "SeaHorse", 0xf49ac1, 0x00aeef);
			        EntityRegistry.addSpawn(EntitySeaHorse.class, (int)(ConfigHandler.FishyRate*10), 4, 9, EnumCreatureType.waterCreature, new BiomeGenBase[] {BiomeGenBase.ocean});
