...
public TeleporterIceAge(WorldServer par1WorldServer)
{
...
public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
{
         ...
         if (d3 >= 0.0D)
         {
                 if (flag)
                 {
                         this.destinationCoordinateCache.add(j1, new IceAgePortalPosition(this, i, j, k, this.worldServerInstance.getTotalWorldTime()));
        ...
        for (i3 = -1; i3 <= 1; ++i3)
        {
            for (j3 = 1; j3 < 3; ++j3)
            {
                for (k3 = -1; k3 < 3; ++k3)
                {
                    ...
                    j4 = k2 + (j3 - 1) * l2 - i3 * l5;
                    flag = k3 < 0;
                    this.worldServerInstance.setBlock(l3, i4, j4, flag ? LotsOMobsBlocks.IceCobble : Blocks.air);
                }
            }
        }
    }
    ...
    for (i3 = 0; i3 < 4; ++i3)
    {
        for (j3 = 0; j3 < 4; ++j3)
        {
            for (k3 = -1; k3 < 4; ++k3)
            {
                ...
                this.worldServerInstance.setBlock(l3, i4, j4, (Block)(flag ? LotsOMobsBlocks.IceCobble : LotsOMobsBlocks.IcePortal), 0, 2);
            }
        }
