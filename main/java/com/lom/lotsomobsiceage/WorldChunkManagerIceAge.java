...
public class WorldChunkManagerIceAge extends WorldChunkManager
{
...
protected WorldChunkManagerIceAge()
{
...
GenLayer[] agenlayer = GenLayerIceAge.makeTheWorld(seed);
this.myGenBiomes = agenlayer[0];
this.myBiomeIndexLayer = agenlayer[1];
}

public WorldChunkManagerIceAge(World world)
{
