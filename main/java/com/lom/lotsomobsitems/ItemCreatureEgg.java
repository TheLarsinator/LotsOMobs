...
public class ItemCreatureEgg extends ItemMonsterPlacer
{
    ...
    public ItemCreatureEgg()
    {
        super();
    }
    
    public ItemCreatureEgg(String parEntityToSpawnName, int parPrimaryColor, 
    ...
    public Entity spawnEntity(World parWorld, double parX, double parY, double parZ)
    {
       ...
       {
            entityToSpawnNameFull = LotsOMobs.modid +"."+entityToSpawnName;
