...
public class ModelBullFrog extends ModelLOMBase
{
  ...
  public ModelBullFrog()
  {
    ...
    textureHeight = 32;
      ...
      this.addChildTo(toe1, bottomleg);
      this.addChildTo(toe2, bottomleg);
      this.addChildTo(toe3, bottomleg2);
      this.addChildTo(toe4, bottomleg2);
  }
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5)
  {
    ...
    this.bottomleg.rotateAngleZ = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
    this.bottomleg2.rotateAngleZ = MathHelper.cos(f * 0.6662F) * 1.4F * f1;
  }
