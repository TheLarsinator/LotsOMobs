...
public void generateSurface(World world, Random rand, int chunkX, int chunkZ) 
{
 ...
 /*   if(biome instanceof BiomeGenTropical)
    ...
    if(biome instanceof BiomeGenOcean)
    {
        ...
        int Xcoord = chunkX + rand.nextInt(50);
        int Zcoord = chunkZ + rand.nextInt(50);
        int i = world.getTopSolidOrLiquidBlock(Xcoord, Zcoord);
        new WorldGenGravelToSand().generate(world, rand, Xcoord, i, Zcoord);
        }
    ...
    if(biome instanceof BiomeGenOcean)
    {
        ...
        int Zcoord = chunkZ + rand.nextInt(50);
        int i = world.getTopSolidOrLiquidBlock(Xcoord, Zcoord);
        new WorldGenSeaUrchin().generate(world, rand, Xcoord, i, Zcoord);
        }
