...
public class EntityAIHop extends EntityAIBase
{
    ...
    public EntityAIHop(EntityCreature par1EntityCreature, float speed, int chanceToMove) {
        this.entity = par1EntityCreature;
        this.speed = speed;
        this.setMutexBits(1);
        this.chanceToMove = chanceToMove;
    }
    public EntityAIHop(EntityCreature par1EntityCreature, float speed, int chanceToMove, boolean shouldHop ) {
    ...
    public boolean shouldExecute() {
    	if (this.entity.getAge() >= 100 && !entity.onGround) {
			return false;
		}
