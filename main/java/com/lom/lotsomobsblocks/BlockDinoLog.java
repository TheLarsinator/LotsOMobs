...
public class BlockDinoLog extends Block
{
	private IIcon theIcon;
public BlockDinoLog(Material Material)
{
         super(Material.wood);
...
public void harvestBlock(World world, EntityPlayer entityplayer, int i, int j, int k, int l)
{
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(LotsOMobs.modid + ":" + "dinowood_side");
        this.theIcon = p_149651_1_.registerIcon(LotsOMobs.modid + ":" + "dinowood_top");
    }
