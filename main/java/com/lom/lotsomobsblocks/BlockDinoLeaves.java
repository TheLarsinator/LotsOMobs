...
public class BlockDinoLeaves extends BlockLeavesBase implements IShearable
{
    int[] field_150128_a;
    ...
    /**
     * Returns the color this block should be rendered. Used by DinoLeaves.
     */
    @SideOnly(Side.CLIENT)
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (!p_149674_1_.isRemote)
        {
            ...
            if ((l & 8) != 0 && (l & 4) == 0)
            {
                ...
                {
                    this.removeDinoLeaves(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_);
                }
            }
        }
    }
    ...
    private void removeDinoLeaves(World p_150126_1_, int p_150126_2_, int p_150126_3_, int p_150126_4_)
    {
