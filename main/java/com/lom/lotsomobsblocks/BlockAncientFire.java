...
public class BlockAncientFire extends BlockFire
{
    @Deprecated
    ...
    {
        this.field_149850_M = new IIcon[] {p_149651_1_.registerIcon("lom:AncientFire_0"), p_149651_1_.registerIcon("lom:AncientFire_1")};
    }
