...
public class BlockEasterCake extends Block
{
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(LotsOMobs.modid + ":" + this.getTextureName() + "_side");
        this.field_150039_M = p_149651_1_.registerIcon(LotsOMobs.modid + ":" + this.getTextureName() + "_inner");
        this.field_150038_a = p_149651_1_.registerIcon(LotsOMobs.modid + ":" + this.getTextureName() + "_top");
        this.field_150037_b = p_149651_1_.registerIcon(LotsOMobs.modid + ":" + this.getTextureName() + "_bottom");
    }
    ...
    public boolean onBlockActivated(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        if(B == 1)
        {
        	p_149727_1_.createExplosion(null, p_149727_2_, p_149727_3_, p_149727_4_, 2, true);
        }
        return true;
    }
    ...
    public void onBlockClicked(World p_149699_1_, int p_149699_2_, int p_149699_3_, int p_149699_4_, EntityPlayer p_149699_5_)
    {
        ...
        p_149699_1_.createExplosion(null, p_149699_2_, p_149699_3_, p_149699_4_, 2, true);
    }
    ...
    {
        return LotsOMobsItems.EasterCake1;
    }
}