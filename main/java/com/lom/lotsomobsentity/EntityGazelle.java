...
public class EntityGazelle extends EntityTameable
{
    ...
    public EntityGazelle(World p_i1696_1_)
    {
        super(p_i1696_1_);
        ...
        this.tasks.addTask(2, this.aiControlledByPlayer = new EntityAIControlledByPlayer(this, 0.8F));
    ...
    public boolean interact(EntityPlayer p_70085_1_)
    {
        ...
        else if (itemstack != null && itemstack.getItem() == Items.wheat && !this.isAngry())
        {
            if (!p_70085_1_.capabilities.isCreativeMode)
            {
                --itemstack.stackSize;
    ...
    {
        return p_70877_1_.getItem() == Items.carrot;
    }
    ...
    public boolean canMateWith(EntityAnimal p_70878_1_)
    {
        ...
        else if (!(p_70878_1_ instanceof EntityGazelle))
        {
            return false;
        }
        else
        {
            EntityGazelle EntityGazelle = (EntityGazelle)p_70878_1_;
            return !EntityGazelle.isTamed() ? false : (EntityGazelle.isSitting() ? false : this.isInLove() && EntityGazelle.isInLove());
        }
    }
