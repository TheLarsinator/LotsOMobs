...
public class EntityKakkerlak extends EntityTameable
{
    ...
    {
        return this.isTamed() ? 0.7F : (this.isAngry() ? 0.1F : 0.1F);
    }
    protected void applyEntityAttributes()
    {
        super.applyEntityAttributes();
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(0.06000001192092896D);
    ...
    public EntityKakkerlak createChild(EntityAgeable p_90011_1_)
    {
        EntityKakkerlak entityBullFrog = new EntityKakkerlak(this.worldObj);
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityKakkerlak))
        {
            return false;
        }
        else
        {
            EntityKakkerlak entitywolf = (EntityKakkerlak)par1EntityAnimal;
    ...
    public boolean func_142018_a(EntityLivingBase par1EntityLivingBase, EntityLivingBase par2EntityLivingBase)
    {
        ...
        {
            if (par1EntityLivingBase instanceof EntityKakkerlak)
            {
                EntityKakkerlak entitywolf = (EntityKakkerlak)par1EntityLivingBase;
