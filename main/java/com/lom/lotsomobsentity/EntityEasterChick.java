...
public class EntityEasterChick extends EntityAnimal
{
    ...
    public float ChickSize()
    {
    	return 0.4F;
    }

    public EntityEasterChick(World par1World)
    {
        super(par1World);
    ...
    public EntityEasterChick createChild(EntityAgeable par1EntityAgeable)
    {
        return new EntityEasterChick(this.worldObj);
    }
