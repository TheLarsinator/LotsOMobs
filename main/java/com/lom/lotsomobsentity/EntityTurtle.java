...
public class EntityTurtle extends EntityTameable
{
    ...
    public boolean canMateWith(EntityAnimal par1EntityAnimal)
    {
        ...
        else if (!(par1EntityAnimal instanceof EntityTurtle))
        {
            return false;
        }
        else
        {
            EntityTurtle entitywolf = (EntityTurtle)par1EntityAnimal;
    ...
    public boolean func_142018_a(EntityLivingBase par1EntityLivingBase, EntityLivingBase par2EntityLivingBase)
    {
        ...
        {
            if (par1EntityLivingBase instanceof EntityTurtle)
            {
                EntityTurtle entitywolf = (EntityTurtle)par1EntityLivingBase;
